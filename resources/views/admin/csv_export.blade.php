                    ...
                    <div class="card card-shadow mb-4">
                        ...
                        <div class="card-body">
                          <div class="form-group row"><br><br>
                            <form name="payment_export" action="{{url('/monthly_payment/export')}}" method="post">
                              <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                              <input type="hidden" name="plan_id" value="888001">
                              <label for="inputPlcName" class="col-sm-4 col-form-label">Date&nbsp;<strong><span style="color: #ff0000">*</span></strong></label>
                              <div class="col-sm-8">
                                  <input name="export_date" type="date"  id="export_date" class="form-control col-sm-8" required>
                                  <span id="ContentPlaceHolder1_RequiredFieldValidator4" style="display:none;"></span>
                                  <span id="ContentPlaceHolder1_rfvname" style="color:Red;display:none;"></span><br><br><br>
                                  <button type="submit" class="payment_export" name="export" style="background:#4d79ff; color:white;">Export</button>
                              </div>
                              </form>
                          </div>
                        </div>
